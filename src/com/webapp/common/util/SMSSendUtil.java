...
public class SMSSendUtil {
	public static JSONObject sendSMSVerifyCode(String number,String verifyCode){
		...
		//*******************************************************************************
		restAPI.setAppId("aaf98f89486445e601487465e19d044e");
		...
		//*********************************************************************************************************************
		result = restAPI.sendTemplateSMS(number,"1" ,new String[]{verifyCode,"5"});
